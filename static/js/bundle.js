...
/***/ function(module, exports, __webpack_require__) {
	...
	var Router1 = __webpack_require__(160)
	ReactDOM.render( React.createElement(Router1, null) , document.getElementById('content'))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Route=__webpack_require__(161).Route
	...
	var Router1 = React.createClass({displayName: "Router1",
		render: function() {
			return React.createElement(Router, {history: history}, 
	            React.createElement(Route, {path: "/", component: Landing}), 
	            React.createElement(Route, {path: "index", component: Layout}, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Navbar = React.createClass({displayName: "Navbar",
	    ...
	    render: function() {
	    return React.createElement("nav", {id: "navbar-main", className: "navbar navbar-default"}, 
	          React.createElement("div", {className: "container"}, 
	            React.createElement("div", {className: "navbar-header"}, 
	              ...
	              React.createElement("a", {className: "navbar-brand", href: "#"}, "Sijan Blog")
	            ), 
	...
	var ContentData= React.createClass({displayName: "ContentData",
	    render: function() {
	    	...
	    	return React.createElement("div", {className: "content"}, 
	                React.createElement("div", {className: "content_body"}, 
	                    React.createElement("h1", {className: "text-uppercase"}, data.title), React.createElement("span", null, data.create_time), 
	                    React.createElement("hr", null), 
	                    React.createElement("p", null, 
	                    data.body
	                    ), 
	                    React.createElement("p", {id: "paragraph_footer"}, "This is the footer. Can have special texts. Will be displayed only of there is any documetns in footer."), 
	                    React.createElement("hr", null), 
	                    React.createElement("div", {className: "visitor_box"}, 
	                        React.createElement("form", null, React.createElement("span", {className: "label label-default"}, "Leave a Reply "), 
	                            React.createElement("input", {className: "form-control input-sm", type: "email", placeholder: "Place your email"}), 
	                            React.createElement("div", {className: "form-group"}, 
	                                React.createElement("textarea", {className: "form-control input-sm", rows: "2", placeholder: "Your Comment"})
	                            ), 
	                            React.createElement("button", {className: "btn btn-success btn-sm", type: "button"}, "Submit ")
	                        ), 
	                        React.createElement("div", {className: "previous_replies"}, 
	                            React.createElement("h5", null, "Sijan replied:"), 
	                            React.createElement("p", {className: "bg-info"}, "Paragraph")
	                        )
	                    )
	                )
	            )
		...
		render: function() {
			...
			React.createElement("header", {className: "page-header"}, 
	            React.createElement("blockquote", null, 
	                React.createElement("p", null, "“A wise man can learn more from a foolish question than a fool can learn from a wise answer.” "), 
	                React.createElement("footer", null, "Bruce Lee")
	            )
			), 
				React.createElement("nav", {id: "navbar-main", className: "navbar navbar-default"}, 
	          React.createElement("div", {className: "container"}, 
	            React.createElement("div", {className: "navbar-header"}, 
	              React.createElement("button", {type: "button", className: "navbar-toggle collapsed", "data-toggle": "collapse", "data-target": "#navbar", "aria-expanded": "false", "aria-controls": "navbar"}, 
	                React.createElement("span", {className: "sr-only"}, "Toggle navigation"), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Landing = React.createClass({displayName: "Landing",
		render: function() {
			return React.createElement("div", null, 
				"Welcome", 
				React.createElement("a", {href: "/index"}, "Click me")
			)			
		}
	})
